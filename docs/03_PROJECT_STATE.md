...
**⭐ En production (2026-07-27)** — **Sprint 11 · The Apple Experience** (en cours) : dashboard médecin premium (hero léger + 5 modules), navigation réduite (sidebar 11→6, sous-docs en filtres du hub), Design System v2 (échelle typo + `.badge`/`.input` canoniques), micro-interactions (entrée unifiée des modales), nettoyage du code mort (~110 lignes retirées). Restant : cap IA strict, écran de connexion unique + Apple, partage patient temps réel. → [CHANGELOG.md](CHANGELOG.md).
