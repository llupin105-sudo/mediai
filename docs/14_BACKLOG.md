...
| 20 | ✅ | Sprint 8 — COMPLET | Lots 1-4 livrés et déployés (module Ordonnance, Action Bar + Quick Create + raccourcis, Centre documentaire + Favoris, micro-interactions & pagination). |
