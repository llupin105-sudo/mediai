...
> Restant du Sprint 11 : Étape 4 (cap IA strict ≤ 6 lignes), Étape 7 (partage patient temps réel), activation réelle d'Apple (identifiants Apple Developer). Étape 10 perf assumée au niveau de la stack (voir plus haut).
